...
Bu API, bir kullanıcının gönderdiği mesajı **LLaMa 3.1 modeli** ile işleyerek ona bir yanıt döndürür.  
API'ye **JSON formatında bir POST isteği** göndererek yanıt alabilirsiniz.
